...
| **C4. Duplex (2-sided)** | Scan Mode = Document Feeder; a 2-sided original; Duplex enabled | Scan | Front and back pages come out, correct and in order (#80) | ☐ | Duplex honored only for the feeder |
